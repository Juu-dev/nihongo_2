...
export const GRAMMAR_DATA = [
    {
        ...
        meaning: "Trong khi, Trong lúc (Mang tính tranh thủ) Trong lúc đang",
        examples: [
    ...
    },
    {
        ...
        title: "間・間に",
        structure: "Vru・N-no",
        meaning: "Trong suốt・Trong khi, trong lúc",
        examples: [
            ...
            { original: "夏休みの間、ずっと祖母の家に滞在した。", translate: "Trong suốt kỳ nghỉ hè, tôi ở lại nhà bà." },
    ...
    },
    {
        ...
        meaning: "Sắp sửa・Đang trong lúc làm V・Vừa mới làm V",
        examples: [
    ...
    },
    {
        ...
        title: "～最中に",
        structure: "Vている・N+の",
        meaning: "Trong lúc đang...・Đúng lúc đang...",
        examples: [
    ...
    },
    {
        ...
        title: "～から～にかけて",
        structure: "～N～N",
        meaning: "Từ... đến.... (khoảng thời gian・không gian)",
        examples: [
    ...
    },
    {
        ...
        title: "Vたきり",
        structure: "Vたきり",
        meaning: "Kể từ khi V (thì không có sự thay đổi nào nữa)",
        examples: [
    ...
    },
    {
        ...
        title: "Vてはじめて",
        structure: "Vてはじめて",
        meaning: "Kể từ khi làm V thì mới nhận ra, hiểu ra...",
        examples: [
    ...
    },
    {
        ...
        title: "Vます+かけ",
        structure: "Vます+かけ",
        meaning: "Làm V còn dang dở, chưa xong",
        examples: [
...

    {
        ...
        structure: "V-Te",
        meaning: "Nếu không làm V1, thì V2 (khó mà thực hiện được...)",
        examples: [
    ...
    },
    {
        ...
        title: "～ため(に)・～ためだ",
        structure: "Vru・N-no",
        meaning: "Bởi vì・Vì (Chỉ nguyên nhân)",
        examples: [
    ...
    },
    {
        ...
        title: "～によって",
        structure: "N+によって",
        meaning: "Do・Vì (đằng sau là hậu quả). Nhờ vào (cách thức)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Vì (Từ việc V dẫn đến kết quả, phán đoán B)",
        examples: [
    ...
    },
    {
        ...
        title: "おかげだ・おかげで",
        structure: "N+no・Vru",
        meaning: "Nhờ vào (đằng sau là kết quả tốt đẹp)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Do, tại vì (đằng sau là kết quả tiêu cực)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Bởi vì (Vì thực sự là....nên đương nhiên)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Nếu・giả sử (Điều kiện giả định)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Nếu (với điều kiện như thế này thì sẽ khó xử, hoặc không làm đc việc như vậy)",
        examples: [
...

    {
        ...
        meaning: "Theo như, đúng theo nhu",
        examples: [
    ...
    },
    {
        ...
        title: "によって・によっては",
        structure: "N+",
        meaning: "Tùy vào・Tùy vào từng trường hợp mà",
        examples: [
    ...
    },
    {
        ...
        title: "～に対して",
        structure: "Vru-no・N",
        meaning: "Đối với (mục tiêu hành động)・Trái ngược với",
        examples: [
    ...
    },
    {
        ...
        title: "一方(で)",
        structure: "Vru",
        meaning: "Một mặt thì V, mặt khác thì",
        examples: [
    ...
    },
    {
        ...
        meaning: "Nên nói là ... thì đúng hơn",
        examples: [
    ...
    },
    {
        ...
        title: "(かの)ようだ・のようだ",
        structure: "N・Vru",
        meaning: "Giống như là・Cứ như là",
        examples: [
    ...
    },
    {
        ...
        title: "～ように",
        structure: "Nno・Vru",
        meaning: "Giống như・Như là, chẳng hạn như",
        examples: [
    ...
    },
    {
        ...
        title: "ように",
        structure: "N+no・Vru",
        meaning: "Đúng như・Như những gì mà (đã nói, đã nghe...)",
        examples: [
...

    {
        ...
        title: "ぐらい",
        structure: "N・Vru",
        meaning: "Chí ít・Ít ra・Cỡ...・Khoảng bằng",
        examples: [
    ...
    },
    {
        ...
        title: "ぐらいなら・くらいなら",
        structure: "Vru",
        meaning: "Nếu phải V thì thà (Về sau thường là ほうがいい・ほうがました)",
        examples: [
    ...
    },
    {
        ...
        title: "N+でも",
        structure: "N+でも",
        meaning: "Thậm chí・Ngay cả・Những thứ như là",
        examples: [
    ...
    },
    {
        ...
        title: "も",
        structure: "N+も",
        meaning: "Hoàn toàn không・Đến ngay cả",
        examples: [
    ...
    },
    {
        ...
        title: "～にとって",
        structure: "N+",
        meaning: "Đối với・Nhìn từ lập trường của",
        examples: [
    ...
    },
    {
        ...
        title: "～として",
        structure: "N+",
        meaning: "Với tư cách・Với vai trò là",
        examples: [
    ...
    },
    {
        ...
        title: "Vるばかりだ",
        structure: "Vるばかりだ",
        meaning: "(Xu hướng) cứ V・(hoàn tất) chỉ còn (chờ) V là xong",
        examples: [
    ...
    },
    {
        ...
        meaning: "Chỉ là・Đơn giản chỉ là",
        examples: [
    ...
    },
    {
        ...
        title: "N+だらけ",
        structure: "N+だらけ",
        meaning: "Đầy, toàn (những thứ gây khó chịu)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Hoàn thành V một cách triệt để",
        examples: [
    ...
    },
    {
        ...
        title: "Vます+通す",
        structure: "Vます+通す",
        meaning: "Suốt V・Làm V một mạch từ đầu đến cuối",
        examples: [
    ...
    },
    {
        ...
        title: "ことにする・ことにしている",
        structure: "Vru・Vnai",
        meaning: "Tôi quyết định (cho bản thân)・Thói quen do tự quyết định",
        examples: [
    ...
    },
    {
        ...
        title: "～ようにする・～ようにしている",
        structure: "Vru・Vnai",
        meaning: "Tôi cố gắng làm gì・Duy trì thói quen cố gắng",
        examples: [
    ...
    },
    {
        ...
        meaning: "Định làm gì (ngay trước hành động)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Ước gì・Mong là (ước cho điều trong tương lai)・Nên・không nên",
        examples: [
    ...
    },
    {
        ...
        meaning: "Hãy ( Mệnh lệnh)・Không được ( Cấm)",
        examples: [
    ...
    },
    {
        ...
        title: "～こと",
        structure: "Vru・Vnai",
        meaning: "Phải・Không được (Mệnh lệnh trong văn cứng)",
        examples: [
    ...
    },
    {
        ...
        title: "～べきだ・～べき・～べきではない",
        structure: "Vる + べきだ",
        meaning: "Nên・Cần làm gì・Không nên làm gì (Lời khuyên)",
        examples: [
    ...
    },
    {
        ...
        title: "～たらどうか",
        structure: "Vta",
        meaning: "Thử làm V xem sao (lời khuyên)",
        examples: [
    ...
    },
    {
        ...
        meaning: "(Bảo・Chú ý・nhờ) hãy V・đừng V",
        examples: [
    ...
    },
    {
        ...
        title: "～とは限らない",
        structure: "Vru",
        meaning: "Không nhất thiết・Chưa chắc đã",
        examples: [
    ...
    },
    {
        ...
        structure: "Vru",
        meaning: "Không phải là・Không hẳn là・Không có nghĩa là",
        examples: [
    ...
    },
    {
        ...
        title: "わけにはいかない",
        structure: "Vる",
        meaning: "Không thể V (về mặt đạo đức・quy tắc)",
        examples: [
    ...
    },
    {
        ...
        meaning: "Cứ tưởng rằng・Cứ cho rằng",
        examples: [
    ...
    },
    {
        ...
        title: "～ものか・もんか",
        structure: "Vる",
        meaning: "Không đời nào・Nhất định không",
        examples: [
    ...
    },
    {
        ...
        title: "～としたら・～とすれば",
        structure: "Vる",
        meaning: "Giả sử (giả định khó xảy ra)",
        examples: [
    ...
    },
    {
        ...
        title: "～と言われている",
        structure: "Vru",
        meaning: "Được cho rằng・Người ta nói rằng",
        examples: [
    ...
    },
    {
        ...
        title: "って～",
        structure: "Vru",
        meaning: "(Trích dẫn) Rằng (văn nói)",
        examples: [
...

    {
        ...
        title: "ないわけにはいかない",
        structure: "Vnai",
        meaning: "Không thể không V (buộc phải V)",
        examples: [
    ...
    },
    {
        ...
        title: "～ことは～が～",
        structure: "VることはVるが",
        meaning: "Có thì có thật đấy.... nhưng mà",
        examples: [
    ...
    },
    {
        ...
        title: "など・なんか・なんて",
        structure: "N+",
        meaning: "Chẳng hạn (đề xuất)・Những thứ như là (coi nhẹ)",
        examples: [
    ...
    },
    {
        ...
        title: "～ように",
        structure: "N+no・Vru",
        meaning: "Để V・Để không V (sự kì vọng)",
        examples: [
    ...
    },
    {
        ...
        title: "～がる",
        structure: "Vたいがる",
        meaning: "Ai đó muốn làm gì (chỉ dùng cho chủ ngữ ngôi 3)",
        examples: [
    ...
    },
    {
        ...
        structure: "Vte",
        meaning: "Rất (đến nỗi không chịu được)",
        examples: [
    ...
    },
    {
        ...
        title: "～ことか・ことに・ことだ",
        structure: "Vる",
        meaning: "Thật là... biết bao (cảm thán)",
        examples: [
    ...
    },
    {
        ...
        title: "～を通じて・～を通して",
        structure: "N+",
        meaning: "Thông qua (phương tiện, cách thức)",
        examples: [
    ...
    },
    {
        ...
        title: "～をこめて",
        structure: "N",
        meaning: "Gửi gắm (tình cảm, tấm lòng, tâm trạng)",
        examples: [
    ...
    },
    {
        ...
        meaning: "N1 là đương nhiên rồi, nhưng N2 cũng",
        examples: [
    ...
    },
    {
        ...
        title: "Nをはじめ(として)",
        structure: "N+",
        meaning: "Trước tiên phải kể đến là",
        examples: [
    ...
    },
    {
        ...
        title: "Vます+出す",
        structure: "Vます+出す",
        meaning: "Bắt đầu làm V (một cách đột ngột)",
        examples: [
    ...
    },
    {
        ...
        title: "Vます+がち",
        structure: "Vます+がち",
        meaning: "Hay V・Thường có khuynh hướng làm V",
        examples: [
